...
sonification.playNote(sonification.map(input.lightLevel(), 0, 255, 294, sonification.chooseScale(SCALE.minor), 2), 1000)
...
sonification.playArray(sonification.mapArray([
    ...
    3,
    15
], 294, sonification.chooseScale(SCALE.minor), 2), 500)
...
// Test the 'playSensor' function with chosen $sensor set to sound. Expected: play a tone whith a frequency resulting from mapping the sound level to the chosen music scale (default).
sonification.playSensor(INPUTSENSOR.SOUND, 262, sonification.chooseScale(SCALE.major), 1, 500)
...
sonification.playSensor(INPUTSENSOR.ACCELERATIONX, 262, sonification.chooseScale(SCALE.major), 1, 500)
...
sonification.playSensor(INPUTSENSOR.ACCELERATIONY, 262, sonification.chooseScale(SCALE.major), 1, 500)
...
sonification.playSensor(INPUTSENSOR.ACCELERATIONZ, 262, sonification.chooseScale(SCALE.major), 1, 500)
...
sonification.playSensor(INPUTSENSOR.ACCELERATIONSTRENGTH, 262, sonification.chooseScale(SCALE.major), 1, 500)
...
sonification.playSensor(INPUTSENSOR.SOUND, 294, [
    1,
    2,
    3,
    4,
